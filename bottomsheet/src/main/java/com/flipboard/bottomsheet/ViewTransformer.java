...
public interface ViewTransformer {
     ...
     * @param parent The {@link BottomSheetLayout} presenting the sheet view. Remember that it can contain multiple
     *               {@link ViewTransformer}s, so exercise caution if manipulating this.
